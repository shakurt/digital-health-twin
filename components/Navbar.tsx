    ...
    <nav className="fixed top-0 left-0 right-0 h-16 bg-dark-card/80 backdrop-blur-lg border-b border-white/5 z-40">
      <div className="h-full px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Docs Button (Mobile & Tablet) */}
          <Link
            href={"/docs"}
            className="lg:hidden p-2.5 rounded-xl bg-dark-bg border border-white/5 hover:border-blue-500/40 transition-all duration-300 group"
          >
            <svg
