      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-4 sm:py-8">
        <div className="mb-6 sm:mb-8 md:mb-12">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-linear-to-br from-purple-500/20 via-pink-500/20 to-blue-500/20 border border-purple-500/30 flex items-center justify-center">
